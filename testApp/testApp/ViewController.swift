...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        daySwitch.rootView.delegate = self
    }
    //MARK: -Set up funcs
...
extension ViewController {
    ...
    func swithdidchage() {
        ...
        diaChange = daySwitch.rootView.vm.$isSelected.sink(receiveValue: { value in
            print("\(value)")
        })
...
extension ViewController: triggerActionProtocol {
    func didTap() {
        print("Switch tapped")
    }
}
